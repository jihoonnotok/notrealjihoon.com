  ...
  <BODY style="BACKGROUND: #fff">
     <DIV class=top style="height: 130px;">
        <DIV class="header clearfix">
           <DIV class=logo  style="MARGIN-TOP: 53px;color: white;font-size: 30px;font-family: 微软雅黑">物流快递管理系统 </DIV>
           <DIV style="margin-top: 53px;margin-left: 700px;color: white">
				<c:if test="${sessionScope.userType==0}">
	                ...
	                <c:if test="${sessionScope.userType==2}">
	                    <span style="color: white;font-size: 17px;font-family: 微软雅黑"> 欢迎您：${sessionScope.songhuoyuan.name }</span>
	                </c:if>
	                &nbsp;&nbsp;&nbsp;
